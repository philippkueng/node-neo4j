...
## Installation
    ...
    npm install node-neo4j@2.0.0-RC8 (to get all the Neo4j 2.0.0 features)
...
All tests should pass if you're running the latest version of Neo4j. (Neo4j 2.0.0-RC8)
...
**Insert a Node**
    ...
    db.insertNode({
        ...
        // Output node id.
        console.log(node.id); /* for 2.0.0-RC8, use: console.log(node._id) */
    });
...
**Insert a Relationship**
    ...
    db.insertRelationship(root_node_id, other_node_id, 'RELATIONSHIP_TYPE', {
        ...
        sideeffects: {
            ...
            console.log(relationship.id); /* for 2.0.0-RC8, use: console.log(relationship._id) */

            // Output relationship start_node_id.
            console.log(relationship.start_node_id); /* for 2.0.0-RC8, use: console.log(relationship._start) */

            // Output relationship end_node_id.
            console.log(relationship.end_node_id); /* for 2.0.0-RC8, use: console.log(relationship._end) */
    });
